...
class jeesGateway(BaseGateway):
    """
    VN Trader Gateway for jees Environment (6.3.13).
    """
    ...
    def __init__(self, event_engine):
        """Constructor"""
        print("jees has inited start")
        super().__init__(event_engine, "JEES")

        self.td_api = CtpTdApi(self)
        #self.md_api = CtpMdApi(self)
        print("jees has inited ok")
...
class CtpTdApi(TdApi):
    ...
    '''def subscribe(self, req: SubscribeRequest): ### use tradeapi to subscribe data 
        """
